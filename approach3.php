 ...
 var shrinkHeader = 300;
  $(window).scroll(function() {
    var scroll = getCurrentScroll();
      ...
      //       $('#header').removeClass('fixed-theme top-nav-collapse');
      ...
      //   }
         ...
         if( scroll >= 0 && scroll >= 300 ) {
          clearClass();
          $('.navbar-brand img').attr('src','images/icons/small-logo.png');
          $('#header').addClass('fixed-theme top-nav-collapse');
          ...
          //   $(this).fadeTo('slow', 1);
          //   });
          $('#content').text('For us, listening to you is the most important step. We want to be certain that we understand your key requirements, what victory feels like and the parts of the project where there’s room for us to be creative.');
          $('#head').text('Listen');
          $('#mark1').addClass('current');

        }

        if( scroll >= 301 && scroll >= 600 ) {
          clearClass();
          $('.tree-all').attr("src",'images/icons/2.png');
